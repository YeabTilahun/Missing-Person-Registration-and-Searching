    ...
    public class MissingPersonController : Controller
    {
        ...
        public IActionResult Create(MissingPerson mp)
        {
            if (mp.ImagePath != null)
            {
                ...
                string imgPath = "";
                string path = "C:\\Users\\Yeabsira\\Desktop\\Face Recognition\\Face Recognition\\wwwroot";
                string path2 = "C:\\Users\\Yeabsira\\Desktop\\Face Recognition\\Face Recognition\\wwwroot\\";
                ...
                try
                {
                    string currentDirectory = "C:\\Users\\Yeabsira\\Desktop\\Face Recognition\\Face Recognition\\models2";
